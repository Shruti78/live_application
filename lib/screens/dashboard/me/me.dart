      ...
      body: Stack(
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 10 * a,
            child: Container(
              padding: EdgeInsets.fromLTRB(13 * a, 16 * a, 11 * a, 17.86 * a),
              width: 70 * a,
              height: 78.86 * a,
              decoration: const BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage('assets/decoration/recharge_agent.png'),
                ),
              ),
              child: CircleAvatar(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/flag.png'), fit: BoxFit.fitWidth),
              ),
            ),
          ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/uf.png'), fit: BoxFit.fitWidth),
              ),
            ),
          ),
          Positioned(
